...
int main(void)
{
  ...
  11:	51                   	push   %ecx
    ...
    pipe(p);
  12:	8d 45 e8             	lea    -0x18(%ebp),%eax
{
  15:	83 ec 20             	sub    $0x20,%esp
    pipe(p);
  18:	50                   	push   %eax
  19:	e8 05 03 00 00       	call   323 <pipe>
    int pid = fork();
  ...
  2d:	6a 00                	push   $0x0
  2f:	e8 07 03 00 00       	call   33b <close>
        dup(p[0]);
  34:	58                   	pop    %eax
  35:	ff 75 e8             	pushl  -0x18(%ebp)
  38:	e8 4e 03 00 00       	call   38b <dup>

        close(p[0]);
  3d:	58                   	pop    %eax
  3e:	ff 75 e8             	pushl  -0x18(%ebp)
  41:	e8 f5 02 00 00       	call   33b <close>
        close(p[1]);
  46:	58                   	pop    %eax
  47:	ff 75 ec             	pushl  -0x14(%ebp)
  4a:	e8 ec 02 00 00       	call   33b <close>

        char *argv[] = {"wc", NULL};
        exec("wc", argv);
  4f:	58                   	pop    %eax
  50:	8d 45 f0             	lea    -0x10(%ebp),%eax
  53:	5a                   	pop    %edx
  54:	50                   	push   %eax
  55:	68 d8 07 00 00       	push   $0x7d8
        char *argv[] = {"wc", NULL};
  5a:	c7 45 f0 d8 07 00 00 	movl   $0x7d8,-0x10(%ebp)
  61:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
        exec("wc", argv);
  68:	e8 de 02 00 00       	call   34b <exec>
  6d:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  70:	e8 9e 02 00 00       	call   313 <exit>
        write(p[1], "hello world\n", 12);
  75:	50                   	push   %eax
  76:	6a 0c                	push   $0xc
  78:	68 db 07 00 00       	push   $0x7db
  7d:	ff 75 ec             	pushl  -0x14(%ebp)
  80:	e8 ae 02 00 00       	call   333 <write>
        close(p[0]);
  85:	5a                   	pop    %edx
  86:	ff 75 e8             	pushl  -0x18(%ebp)
  89:	e8 ad 02 00 00       	call   33b <close>
        close(p[1]);
  8e:	59                   	pop    %ecx
  8f:	ff 75 ec             	pushl  -0x14(%ebp)
  92:	e8 a4 02 00 00       	call   33b <close>
        wait();
  97:	e8 7f 02 00 00       	call   31b <wait>
  9c:	83 c4 10             	add    $0x10,%esp
  9f:	eb cf                	jmp    70 <main+0x70>
  a1:	66 90                	xchg   %ax,%ax
  a3:	66 90                	xchg   %ax,%ax
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
