  ...
  18:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	50                   	push   %eax
  21:	50                   	push   %eax
  22:	68 38 08 00 00       	push   $0x838
  27:	6a 01                	push   $0x1
  29:	e8 a2 04 00 00       	call   4d0 <printf>
        exit();
  2e:	e8 40 03 00 00       	call   373 <exit>
    }
  ...
  3a:	e8 74 03 00 00       	call   3b3 <open>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	89 c6                	mov    %eax,%esi
  44:	85 c0                	test   %eax,%eax
  46:	0f 88 8e 00 00 00    	js     da <main+0xda>
  ...
  56:	e8 58 03 00 00       	call   3b3 <open>
  5b:	83 c4 10             	add    $0x10,%esp
  5e:	89 c7                	mov    %eax,%edi
  60:	85 c0                	test   %eax,%eax
  62:	79 32                	jns    96 <main+0x96>
      printf(1, "cp: cannot open %s\n", argv[2]);
  64:	51                   	push   %ecx
  65:	ff 73 08             	pushl  0x8(%ebx)
  68:	68 56 08 00 00       	push   $0x856
  6d:	6a 01                	push   $0x1
  6f:	e8 5c 04 00 00       	call   4d0 <printf>
      exit();
  74:	e8 fa 02 00 00       	call   373 <exit>
  ...
  83:	53                   	push   %ebx
  84:	68 80 0b 00 00       	push   $0xb80
  89:	57                   	push   %edi
  8a:	e8 04 03 00 00       	call   393 <write>
  8f:	83 c4 10             	add    $0x10,%esp
  92:	39 d8                	cmp    %ebx,%eax
  94:	75 31                	jne    c7 <main+0xc7>
    while ((n = read(src_fd, buf, sizeof(buf))) > 0) {
  96:	83 ec 04             	sub    $0x4,%esp
  99:	68 00 02 00 00       	push   $0x200
  9e:	68 80 0b 00 00       	push   $0xb80
  a3:	56                   	push   %esi
  a4:	e8 e2 02 00 00       	call   38b <read>
  a9:	83 c4 10             	add    $0x10,%esp
  ac:	89 c3                	mov    %eax,%ebx
  ae:	85 c0                	test   %eax,%eax
  b0:	7f ce                	jg     80 <main+0x80>
            printf(1, "cp: write error\n");
        }
    }
    if(n < 0) {
  b2:	74 3b                	je     ef <main+0xef>
        printf(1, "cp: read error\n");
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 7b 08 00 00       	push   $0x87b
  bb:	6a 01                	push   $0x1
  bd:	e8 0e 04 00 00       	call   4d0 <printf>
        exit();
  c2:	e8 ac 02 00 00       	call   373 <exit>
            printf(1, "cp: write error\n");
  c7:	52                   	push   %edx
  c8:	52                   	push   %edx
  c9:	68 6a 08 00 00       	push   $0x86a
  ce:	6a 01                	push   $0x1
  d0:	e8 fb 03 00 00       	call   4d0 <printf>
  d5:	83 c4 10             	add    $0x10,%esp
  d8:	eb bc                	jmp    96 <main+0x96>
      printf(1, "cp: cannot open %s\n", argv[1]);
  da:	50                   	push   %eax
  db:	ff 73 04             	pushl  0x4(%ebx)
  de:	68 56 08 00 00       	push   $0x856
  e3:	6a 01                	push   $0x1
  e5:	e8 e6 03 00 00       	call   4d0 <printf>
      exit();
  ea:	e8 84 02 00 00       	call   373 <exit>
    }

    close(src_fd);
  ef:	83 ec 0c             	sub    $0xc,%esp
  f2:	56                   	push   %esi
  f3:	e8 a3 02 00 00       	call   39b <close>
    close(dest_fd);
  f8:	89 3c 24             	mov    %edi,(%esp)
  fb:	e8 9b 02 00 00       	call   39b <close>
